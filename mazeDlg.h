...
class mazeDlg : public wxDialog
{
	...
	NEAT::Population* newpop;
        wxTimer *timer;
		mazeDlg(wxWindow *parent, wxWindowID id = 1, const wxString &title = wxT("maze"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxDefaultSize, long style = mazeDlg_STYLE);
		virtual ~mazeDlg();
		Environment *env;
